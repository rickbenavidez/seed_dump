  ...
  describe '.dump' do
    ...
    context 'without file option' do
      it 'should return the dump of the models passed in' do
        expect(SeedDump.dump(Sample, enumeration: :find_each)).to eq(expected_output)
      end
    end
    ...
    context 'with file option' do
      ...
      it 'should dump the models to the specified file' do
        SeedDump.dump(Sample, file: @filename, enumeration: :find_each)
      ...
      context 'with append option' do
        it 'should append to the file rather than overwriting it' do
          SeedDump.dump(Sample, file: @filename, enumeration: :find_each)
          SeedDump.dump(Sample, file: @filename, append: true, enumeration: :find_each)
    ...
    context 'with a batch_size parameter' do
      it 'should not raise an exception' do
        SeedDump.dump(Sample, batch_size: 100, enumeration: :find_each)
      end

      it 'should not cause records to not be dumped' do
        expect(SeedDump.dump(Sample, batch_size: 2, enumeration: :find_each)).to eq(expected_output)
        expect(SeedDump.dump(Sample, batch_size: 1, enumeration: :find_each)).to eq(expected_output)
      end
    end
